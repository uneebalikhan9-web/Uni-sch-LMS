...
router.post('/apply', handlePhotoUpload, async (req, res) => {
  try {
    ...
    const data = {
      ...
      cnic: cleanCnic || null,
      religion: body.religion ? body.religion.trim() : 'Islam',
      nationality: body.nationality ? body.nationality.trim() : 'Pakistani',
      ...
      emergency_name: body.emergency_name ? body.emergency_name.trim() : null,
      emergency_phone: body.emergency_phone ? body.emergency_phone.trim() : null,
      emergency_relation: body.emergency_relation ? body.emergency_relation.trim() : null,
      ...
      passing_year: body.passing_year ? body.passing_year.trim() : null,
