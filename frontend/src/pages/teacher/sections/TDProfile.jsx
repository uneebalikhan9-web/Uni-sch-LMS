...
export default function TDProfile({ user, courses, students, teacherClasses }) {
  ...
  const profileAvatar = { width:'90px', height:'90px', borderRadius:'28px', background:'linear-gradient(135deg, #4f46e5, #818cf8)', color:'#fff', display:'flex', alignItems:'center', justifyContent:'center', fontSize:'36px', fontWeight:'800', margin:'0 auto 16px', boxShadow:'0 15px 30px -10px rgba(79,70,229,0.3)' };
  ...
  return (
    <div style={profileCard} className="animate-fadeIn">
      ...
      <div style={profileStats}>
        <div style={profileStatItem}><div style={{ fontSize:'1.5rem', fontWeight:'800', color:'#4f46e5' }}>{courses.length}</div><div style={{ fontSize:'0.75rem', color:'#64748b', fontWeight:'600' }}>Courses</div></div>
        <div style={profileStatItem}><div style={{ fontSize:'1.5rem', fontWeight:'800', color:'#4f46e5' }}>{students.length}</div><div style={{ fontSize:'0.75rem', color:'#64748b', fontWeight:'600' }}>Students</div></div>
        <div style={profileStatItem}><div style={{ fontSize:'1.5rem', fontWeight:'800', color:'#4f46e5' }}>{teacherClasses.length}</div><div style={{ fontSize:'0.75rem', color:'#64748b', fontWeight:'600' }}>Classes</div></div>
      </div>
      <div style={infoGrid}>
